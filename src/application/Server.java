...
public class Server  implements ActionListener{
	...
	Server(){
	   ...
	   ImageIcon i4 = createImageIcon("/application/icons/1.png","server");
...
@Override
   public void actionPerformed(ActionEvent arg0) {
      try {
       String out = t.getText();//get text from textbox
       sendTextToFile(out);
